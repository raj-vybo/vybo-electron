...
const GreenPenSvg = ({ strokeColor }: { strokeColor: string }) => {
  return (
    <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1">
      <title>green pen</title>
      <g
        ...
        fillRule="evenodd"
      >
        <g id="App-icons" transform="translate(-77.000000, -314.000000)">
          <g id="green-pen" transform="translate(78.000000, 315.000000)">
            <rect
              id="Rectangle-Copy-5"
              stroke={strokeColor}
              fill="#2A303E"
